...
Many journals allow authors to post this version of their manuscripts to a preprint server. You can find out more about preprint servers [here](https://www.csdisseminate.com/preprint-servers).
...
[Try it](https://v2.sherpa.ac.uk/romeo/)
...
The following steps are general guidelines for archiving submitted, accepted, and published versions of your manuscripts. You may need to adapt them based on [the information you found in the copyright policies](https://www.notion.so/Learn-to-Self-Archive-22e4a8e3bdb14ffb89f8955e577ea2be?pvs=21).
...
1.  Attach a preprint notice to the first page of your submitted manuscript, for example:
    ...
    1.  *This manuscript is in submission for publication. It has not yet been peer reviewed.*

2.  Post the submitted manuscript to a [preprint server](https://www.csdisseminate.com/preprint-servers).
...
1.  Attach a [user license](https://www.csdisseminate.com/advanced-options) to the first page of your accepted manuscript, for example:

    1.  *This is the accepted version of an article published by \[Publisher\] in \[Journal\], © \[Year\], \[Volume (Issue)\], \[Page Range\]. It is available online at \[DOI\] and is made available here with the permission of \[Publisher\]. Licensed under the Creative Commons \[license details and URL, if applicable\].*
...
First, make sure you've gone through [all the steps](https://www.csdisseminate.com/for-scientists).

Then, check our [FAQs page](https://www.csdisseminate.com/for-scientists).

Finally, if you're still stuck, feel free to [reach out to us](https://www.csdisseminate.com/contact).
