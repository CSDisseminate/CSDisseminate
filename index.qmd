...
listing:
  ...
  - id: featured-scientists
    ...
    sort: "date desc"
    type: grid
    template: ejs/featured-scientist.ejs
    categories: false
    sort-ui: false
    filter-ui: false
    max-items: 2
...
<img src="Images/CSDisseminate Logo_White Logo_Purple Background Circle.png" alt="CSDisseminate Logo" style="width: 260px;"/>

::: {style="font-size: 2em; font-weight: 700; margin-top: 1em;"}
CSDisseminate
:::

::: {style="text-align: center;  margin: 1em auto; max-width: 350px;"}
...
::::: {style="background-color: var(--darken($body-bg, 20%)); color: var(--bs-body-color); border-radius: 20px; padding: 2em; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;"}
